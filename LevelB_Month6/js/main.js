/* ============================================================
   Farmer Month — shared JavaScript (Level B, Month 6)
...
let audioContext;
let soundEnabled = localStorage.getItem('farmerMonthSound') !== 'off';
...
function playClickSound() {
  playTone(520, 0.11, 0.08, 'triangle');
  playTone(780, 0.12, 0.05, 'sine', 0.045);
}
...
function toggleSound() {
  ...
  localStorage.setItem('farmerMonthSound', soundEnabled ? 'on' : 'off');
  updateSoundButton();
